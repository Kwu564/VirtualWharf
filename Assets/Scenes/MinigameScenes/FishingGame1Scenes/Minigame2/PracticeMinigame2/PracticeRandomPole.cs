...
public class PracticeRandomPole : MonoBehaviour {
	...
	public string GoToFishingScene;
	...
	IEnumerator Info()
	{
		...
		if (P1Rod == WinningRod)
		{
			...
			print("Player1 won!");
			PracticeMinigame2Data.player1Fish += 1;
		}
		else if(P2Rod == WinningRod)
		{
			WinnerName.text = "Player 2 caught";
			print("Player1 won!");
			PracticeMinigame2Data.player2Fish += 1;
		}
		//P1Rod = -1;
		//P2Rod = -1;
	...
	/*	if (MiniGame2Data.player1Fish > MiniGame2Data.player2Fish)
		...
		*/
		SceneManager.LoadSceneAsync(GoToFishingScene);
	}
}
